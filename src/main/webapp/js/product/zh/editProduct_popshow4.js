												...
												$
														.each(
																...
																function(k, l) {
																	...
																	tr1
																			.append($("<td><input class='pro_price' type='text' name='skuCode'><input class='pro_sku_id' type='hidden' name='skuId'><input type='hidden' name='barCodeImg' value='Http://image01.3qianwan.com/h0/group1/1'/></td>"));
