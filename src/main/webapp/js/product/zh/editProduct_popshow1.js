			...
			$.each(chim,function(j,m){
				...
				if(j == 0){
					...
					tr1 = $("<tr ><td class='yan' id='"+ n.id +"' rowspan='"+ chimlen +"'>"+ n.value +"</td><td class='chi' id='"+ m.id +"'>"+ m.value +"</td><td>" +
							"<input class='pro_price' type='text' name='skuCode'><input class='pro_sku_id' type='hidden' name='skuId'><input type='hidden' name='barCodeImg' value='Http://image01.3qianwan.com/h0/group1/1'/></td></tr>")
		...
		$.each(yanse,function(i,n){
			...
			$.each(chim,function(j,m){
				$.each(chim2,function(k,l){
					...
					tr1.append($("<td><input class='pro_price' type='text' name='skuCode'><input class='pro_sku_id' type='hidden' name='skuId'><input type='hidden' name='barCodeImg' value='Http://image01.3qianwan.com/h0/group1/1'/></td>"));
